...
const Categories = () => {
 return (
    <div className="flex justify-between p-4 px-9 m-5">
      ...
      <Link to="/science" className="text-black hover:scale-105 transition-transform duration-300 hover:text-amber-600 hidden lg:block">Ciencia y Tecnología</Link>
      <Link to="/culture" className="text-black hover:scale-105 transition-transform duration-300 hover:text-amber-600 hidden lg:block">Cultura y Seguridad Digital</Link>
      ...
      <Link to="/last" className="text-black hover:scale-105 transition-transform duration-300 hover:text-amber-600 hidden lg:block">Últimas Noticias</Link>
    </div>
 );
};

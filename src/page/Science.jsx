...
return(
  ...
  <h3 className="font-bold bg-[#e11d48] sm:mr-4 lg:mr-8 sm:text-2xl lg:text-2xl text-white mb-2 mt-[-70px] md:mt-[-70px] lg:mt-[-19px]  py-1 px-4 rounded-xs w-full" >Ciencia y Tecnología</h3>
...
<div>
  <h3 className="font-bold sm:mr-4 lg:mr-8 text-2xl lg:text-xl text-[#e11d48] mt-[-30px] lg:mt-[-35px] md:mt-[-40px] py-3 rounded-xs w-[-100px] ">Ultimas Noticias</h3>
  <div className="bg-[#e11d48] h-[5px] w-full mt-[-10px] mb-6"></div>
  ...
  <div className="lg:flex-1 mr-0 md:mb-2 lg:mb-[8px] sm:"> {/* Ajustar el tamaño del contenedor principal */}
    ...
    { relevantSciencePostCategoryData
     .map(post => (
      <MainArticle
...
<h3 className="font-bold sm:mr-4 lg:mr-8 text-2xl lg:text-2xl text-[#e11d48] mt-[-10px] lg:mt-[26px] md:mt-[7px] py-3 rounded-xs w-[-100px]">Tendencias</h3>
  <div className="bg-[#e11d48] h-[7px] w-full mt-[-10px] mb-3"></div>
